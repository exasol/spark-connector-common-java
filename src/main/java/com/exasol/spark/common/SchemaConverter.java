...
public final class SchemaConverter {
    ...
    private DataType mapJDBCType(final ColumnDescription column) {
        ...
        switch (jdbcType) {
            ...
            case Types.CHAR, Types.NCHAR, Types.VARCHAR, Types.NVARCHAR, Types.LONGVARCHAR, Types.LONGNVARCHAR, Types.BINARY, Types.VARBINARY, Types.LONGVARBINARY:
    ...
    private DataType createDecimalDataType(final int precision, final int scale) {
